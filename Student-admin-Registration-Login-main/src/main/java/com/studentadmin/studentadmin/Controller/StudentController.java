...
public class StudentController {
    ...
    public  String register(@ModelAttribute StudentModel studentModel){
        ...
        StudentModel registeredStudent=studentService.registerStudent(studentModel.getName(),studentModel.getEmail(), studentModel.getAddress(), studentModel.getCourse(), studentModel.getPassword(),studentModel.getMobileNo());
    ...
    public  String login(@ModelAttribute StudentModel studentModel,Model model){
        ...
        if(authenticated !=null){
            ...
            model.addAttribute("mobileNo",authenticated.getMobileNo());
            return "student_page";
